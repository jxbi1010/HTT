...
def vit_tiny(patch_size=16, depth=12, num_register_tokens=0, mlp_ratio=4, **kwargs):
...
def vit_small(patch_size=16, num_register_tokens=0, mlp_ratio=4, **kwargs):
    model = VisionTransformer(
        patch_size=patch_size,
        embed_dim=384,
        depth=12,
...
def vit_base(patch_size=16, num_register_tokens=0, mlp_ratio=4, **kwargs):
    model = VisionTransformer(
        patch_size=patch_size,
        embed_dim=768,
        depth=12,
...
def vit_large(patch_size=16, num_register_tokens=0, mlp_ratio=4, **kwargs):
    model = VisionTransformer(
        patch_size=patch_size,
        embed_dim=1024,
        depth=24,
